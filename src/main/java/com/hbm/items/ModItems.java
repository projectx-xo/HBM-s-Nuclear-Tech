...
public class ModItems {
	...
	public static void initializeItem() {
		...
		mp_thruster_20_solid_american_flag = ((ItemCustomMissilePart) mp_thruster_20_solid).copy().setTitle("American").setUnlocalizedName("mp_thruster_20_solid_american_flag");
		...
		mp_stability_20_american_flag = ((ItemCustomMissilePart) mp_stability_20_white).copy().setTitle("American").setUnlocalizedName("mp_stability_20_american_flag");
		...
		mp_fuselage_20_solid_american_flag = ((ItemCustomMissilePart) mp_fuselage_20_solid_minuteman).copy().setTitle("American").setUnlocalizedName("mp_fuselage_20_solid_american_flag");
		...
		mp_warhead_20_buster_thermonuclear_american_flag = new ItemCustomMissilePart().makeWarhead(WarheadType.BUSTER_THERMONUCLEAR, 250F, 10F, PartSize.SIZE_20).setHealth(40F).setTitle("American").setUnlocalizedName("mp_warhead_20_buster_thermonuclear_american_flag");
